            ...
            <div class="reply__body">
                ...
                <form action="#">
                    <div class="reply__wrapper">
						<?php echo do_shortcode('[contact-form-7 id="120" title="Форма вопроса"] '); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('inst', 2); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('fb', 2); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('uytub', 2); ?>" class="footer__social-item">
