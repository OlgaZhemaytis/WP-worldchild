            ...
            <div class="glide__track" data-glide-el="track">
				...
				<?php
						...
						foreach( $posts as $post ){
							setup_postdata($post);
							?>
								<li style="background-image: url('<?php the_field('slaider_img'); ?>')" class="glide__slide">
                       				 <div class="container">
										<div class="row">
											<div class="col-lg-7 offset-1">
												<h2 
												style="<?php $field = get_field('slaider_color');
												if($field == 'white'){
													?>
														color: #fff
													<?php
												...
												<?php $field = get_field('slaider_btn');
												if($field == 'on'){
													?>
														<a href="<?php the_field('slaider_link') ?>" class="button">Узнать больше</a>
													<?php
												}
												?>"		
											</div>
								...
								if(has_post_thumbnail()){
								 ...
								 ?>)">
									<div class="toys__item-info">
										...
										<div class="toys__item-descr"> <?php the_field('toy_descr'); ?></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
						...
						<?php echo do_shortcode ('[contact-form-7 id="119" title="Форма отзывов"]'); ?>
						</div>
									...
									foreach( $posts as $post ){
										...
										<li class="glide__slide">
													<div class="feedslider__title">
														<?php the_field('otz_title'); ?>
													</div>
													<div class="feedslider__text">
													<?php the_field('otzv_descr'); ?>
													</div>
										</li>
